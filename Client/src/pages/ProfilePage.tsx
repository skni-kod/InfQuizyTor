  ...
  return (
    <div className={styles.profileContainer}>
      <header className={styles.profileHeader}>
        <h1>Witaj, {authState.user.first_name}!</h1>
        <p>Oto Twój profil.</p>
      </header>
      ...
      <div className={styles.profileDetails}>
        ...
        <div className={styles.detailItem}>
          ...
          <span className={styles.detailValue}>{authState.user.last_name}</span>
        </div>
        <div className={styles.detailItem}>
          <span className={styles.detailLabel}>Email</span>
          <span className={styles.detailValue}>
            {authState.user.email || "Brak"}
          </span>
        </div>
        <div className={styles.detailItem}>
          <span className={styles.detailLabel}>USOS ID</span>
          <span className={styles.detailValue}>{authState.user.id}</span>
        </div>
      </div>
